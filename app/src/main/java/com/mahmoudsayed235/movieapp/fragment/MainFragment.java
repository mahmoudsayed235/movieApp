package com.mahmoudsayed235.movieapp.fragment;
...
import com.mahmoudsayed235.movieapp.util.OnMovieEventListener;
import com.mahmoudsayed235.movieapp.adapter.MovieAdapter;
import com.mahmoudsayed235.movieapp.entity.Movie;
import com.mahmoudsayed235.movieapp.entity.Review;
import com.mahmoudsayed235.movieapp.entity.Trailer;
import com.mahmoudsayed235.movieapp.util.MessageUtil;
import com.mahmoudsayed235.movieapp.util.fetcher.FetchMovieData;
import com.mahmoudsayed235.movieapp.util.fetcher.FetchReviewData;
import com.mahmoudsayed235.movieapp.util.fetcher.FetchTrailerData;
import com.mahmoudsayed235.movieapp.util.parser.MovieJsonHandler;
import com.mahmoudsayed235.movieapp.util.parser.PersistanceUtil;
import com.mahmoudsayed235.movieapp.util.parser.ReviewJsonHandler;
import com.mahmoudsayed235.movieapp.util.parser.TrailerJsonHandler;
    ...
    private class LoadMovieData extends AsyncTask<Integer, Void, Integer> {
        ...
        protected Integer doInBackground(Integer... flag) {
            ...
            try {
                ...
                movie.getTrailers().addAll((Collection<? extends Trailer>) TrailerJsonHandler.parseJsonToTrailerList(json));
                String json1 = frd.fetch(flag[0] + "", 1);
                movie.setReviews(new ArrayList<Review>());
                movie.getReview().addAll((Collection<? extends Review>) ReviewJsonHandler.parseJsonToReviewList(json1));
                // }else
                if (movie.isFavorite()) {
